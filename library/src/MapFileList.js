  ...
  maps: [
    ...
    },
    {
      ...
      maps: [
        ...
        { fileName: "2364032.data", name: "(E5C?) Thunderhead Peaks" },
        { fileName: "2365787.data", name: "(E5C?) Snowden Drifts" },
        { fileName: "2366368.data", name: "(E5C?) Fireheart Rise" },
        { fileName: "2366776.data", name: "(E5C?) Fields of Ruin" },
        { fileName: "2367211.data", name: "(E5C?) Bloodtide Coast" },
        { fileName: "2368400.data", name: "(E5C?) Lake Doric" },
