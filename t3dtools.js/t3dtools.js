...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_inflate')) {
        Object.defineProperty(Module['ready'], '_inflate', { configurable: true, get: function() { abort('You are getting _inflate on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_inflate', { configurable: true, set: function() { abort('You are setting _inflate on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_workImage')) {
        Object.defineProperty(Module['ready'], '_workImage', { configurable: true, get: function() { abort('You are getting _workImage on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_workImage', { configurable: true, set: function() { abort('You are setting _workImage on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile = 't3dtools.wasm';
